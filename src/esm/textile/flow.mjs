...
import fixlinks from "./fixlinks.mjs";
import {
  parseHtml,
  tokenize,
  parseHtmlAttr,
...
import parsePhrase from "./pharse.mjs";
import { copyAttr, parseAttr } from "./attr.mjs";
import { testList, parseList } from "./list.mjs";
import { testDefList, parseDefList } from "./deflist.mjs";
import { testTable, parseTable } from "./table.mjs";
import { txblocks, txlisthd, txattr } from "./re_ext.mjs";
 ...
 *
 * @param {string} src
 * @param {import("../types.mjs").Options} [option]
 * @returns {import("../types.mjs").JsonMLNodes}
 */
