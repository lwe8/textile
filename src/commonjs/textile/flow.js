...
const fixLinks = require("./fixlinks.js");
...
const { parsePhrase } = require("./phrase.js");
const { copyAttr, parseAttr } = require("./attr.js");
const { testList, parseList } = require("./list.js");
const { testDefList, parseDefList } = require("./deflist.js");
const { testTable, parseTable } = require("./table.js");

const { txblocks, txlisthd, txattr } = require("./re_ext.js");
